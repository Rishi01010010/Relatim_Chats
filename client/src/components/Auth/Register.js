    ...
    <Container>
      <FormContainer className="fade-in">
        ...
        <Form onSubmit={handleSubmit}>
          ...
          />
          <Button type="submit" disabled={loading} className="scale-in" style={{ animationDelay: '0.4s' }}>
            {loading ? 'Creating Account...' : 'Sign Up'}
          </Button>
        </Form>
        <ToggleButton onClick={onToggleMode} className="fade-in" style={{ animationDelay: '0.5s' }}>
